...
def all_patterns(name):
    ...
    if u'.' in name:
        ...
        u_name = power_twoname_match.format(
            fmt_name=simple_name, fmt_attr=simple_attr)
...
class FixImports(fixer_base.BaseFix):
    ...
    def fix_submod_import(self, imported, name, node):
        ...
        if missed:
            self.warning(
                node, u"Imported names not known to 3to2 to be part of the package {0}.  Leaving those alone... high probability that this code will be incorrect.".format(name))
